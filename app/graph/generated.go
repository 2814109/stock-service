...
//go:embed "mutation.graphqls" "schema.graphqls"
...
func (ec *executionContext) fieldContext_Sample_id(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Sample",
		Field:      field,
		IsMethod:   false,
